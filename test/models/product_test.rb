...
class ProductTest < ActiveSupport::TestCase
	...
	test "product prices must be positive" do
		product = Product.new(title: "Book Title", description:"desc", image_url:"yyy.jpg")
		product.price = -1
		assert product.invalid?
	...
	test "product is not valid with a unique title" do
		product = Product.new(title: products(:ruby).title, description:"yyy", price: 1, image_url: "stuff.jpg")
		assert product.invalid?
